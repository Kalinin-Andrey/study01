...
func TestSigner(t *testing.T) {
	...
	//fmt.Printf("\n\n int(OverheatLockCounter) != len(inputData): %v != %v \n int(OverheatUnlockCounter) != len(inputData): %v != %v \n int(DataSignerMd5Counter) != len(inputData): %v != %v \n int(DataSignerCrc32Counter) != len(inputData)*8: %v != %v * 8 \n", int(OverheatLockCounter), len(inputData), int(OverheatUnlockCounter), len(inputData), int(DataSignerMd5Counter), len(inputData), int(DataSignerCrc32Counter), len(inputData))
}
